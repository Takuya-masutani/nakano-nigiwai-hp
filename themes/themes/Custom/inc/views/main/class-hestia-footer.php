...
class Hestia_Footer extends Hestia_Abstract_Main {
	...
	private function wrapped_bottom_footer_content() {
		echo '<div class="hestia-bottom-footer-content inner">';
	...
	public function bottom_footer_content() {
		...
		<?php if ( ! empty( $hestia_general_credits ) || is_customize_preview() ) : ?>
			<div class="footer_info">
				<p>●●●●株式会社<br>東京都●●●●1丁目00-00<br>TEL：03-0000-0000 / FAX：03-0000-0000</p>
			</div>
			<div class="copyright"><p class="center">&copy;XXXXXXXXXXXXXXXXXXXXXXX Co.,Ltd.</p></div>
			<?php
		endif;
	}
